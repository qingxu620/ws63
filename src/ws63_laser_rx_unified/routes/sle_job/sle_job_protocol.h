...
#define SLE_JOB_PACKET_FLAG_DATA_FAST_ACK 0x01U
#define SLE_JOB_PACKET_FLAG_DATA_FORCE_ACK 0x02U
...
typedef enum {
    ...
    SLE_JOB_PKT_OWNER_CLAIM   = 0x16,
    SLE_JOB_PKT_OWNER_RELEASE = 0x17,
...
typedef struct __attribute__((packed)) {
    ...
    uint8_t reserved0;
    uint16_t reserved1;
} sle_job_owner_control_payload_t;
