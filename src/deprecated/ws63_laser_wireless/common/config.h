...
#define HEARTBEAT_IDLE_INTERVAL_MS 1000U
#define SLE_TX_HEARTBEAT_IDLE_ENABLE 1
...
#define CMD_URGENT_REPEAT_COUNT 3U
#define CMD_URGENT_REPEAT_INTERVAL_MS 15U
#define TX_OUTBOUND_QUEUE_SIZE 512U
#define SLE_TX_BUSINESS_MAX_PENDING 1U
