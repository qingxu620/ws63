...
#define	LCD_LED(n) (n?HAL_GPIO_WritePin(GPIOD,GPIO_PIN_6,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOD,GPIO_PIN_6,GPIO_PIN_RESET))    		 
...
#define	LCD_CS_SET  GPIO_TYPE->BSRRL=1<<LCD_CS    
#define	LCD_RS_SET	GPIO_TYPE->BSRRL=1<<LCD_RS      
#define	LCD_RST_SET	GPIO_TYPE->BSRRL=1<<LCD_RST    
