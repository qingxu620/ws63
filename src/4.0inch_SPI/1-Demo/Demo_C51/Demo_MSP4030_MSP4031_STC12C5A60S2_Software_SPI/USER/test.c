...
void main_test(void)
{
	...
	Gui_StrCenter(0,90,BRED,BLUE,"4.0\" IPS ST7796 320X480",16,1);//居中显示
	Gui_StrCenter(0,120,BLUE,BLUE,"xiaoFeng@QDtech 2023-11-20",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
...
//	u8 i=0,j=0;	 
	...
	while(1)
	{
		...
		//{
			...
			{
				if(tp_dev.x[0]<(lcddev.width-2)&&tp_dev.y[0]<(lcddev.height-2))//在LCD范围内
				{
					if(lastpos[0]==0XFFFF)
					{
