...
LCDWIKI_SPI::LCDWIKI_SPI(uint16_t model,int8_t cs, int8_t cd, int8_t miso, int8_t mosi, int8_t reset, int8_t clk, int8_t led)
{
	...
	{
		spimisoPort = portInputRegister(digitalPinToPort(_miso));
	...
	switch(ID)
	{
		...
		case 0x9341:
            ...
            //	ILI9341_FRAMECONTROL, 2, 0x00, 0x1B,        //Frame Control [00 1B]
                ...
                0xC0, 1, 0x13,
                0xC1, 1, 0x13,
                0xC5, 2, 0x1C, 0x35,  //VCM control //22 //35
                0xC7, 1, 0xC8, //VCM control2  //AF
                0x21, 0,
                ...
                0xF2, 1, 0x00,
                0x26, 1, 0x01,
                0xE0, 15, 0x0F, 0x35, 0x31, 0x0B, 0x0E, 0x06, 0x49, 0xA7, 0x33, 0x07, 0x0F, 0x03, 0x0C, 0x0A, 0x00,
                0xE1, 15, 0x00, 0x0A, 0x0F, 0x04, 0x11, 0x08, 0x36, 0x58, 0x4D, 0x07, 0x10, 0x0C, 0x32, 0x34, 0x0F,
			    TFTLCD_DELAY8, 120,
                0x11, 0,
                0x29, 0,  //Display on 
            };
      ...
      //      	0x13, 0,
		...
		case 0x7796:
			...
			static const uint8_t ST7796S_regValues[] PROGMEM = 
			{
				...
				0xE0, 14, 0xD0, 0x08, 0x0F, 0x06, 0x06, 0x33, 0x30, 0x33, 0x47, 0x17, 0x13, 0x13, 0x2B, 0x31,
				0xE1, 14, 0xD0, 0x0A, 0x11, 0x0B, 0x09, 0x07, 0x2F, 0x33, 0x47, 0x38, 0x15 ,0x16, 0x2C, 0x32,				
				0xF0, 1, 0x3C,
				0xF0, 1, 0x69, 
				TFTLCD_DELAY8, 120, 
				0x21, 0,
