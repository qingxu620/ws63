...
//SPI操作
//GPIO置位（拉高）
#define	SPI_SCLK_SET  SPI_GPIO->BSRRL=1<<SPI_SCLK    		  
#define	SPI_MOSI_SET	SPI_GPIO->BSRRL=1<<SPI_MOSI  		  

//GPIO复位（拉低）							    
#define	SPI_SCLK_CLR  SPI_GPIO->BSRRH=1<<SPI_SCLK       	 
#define	SPI_MOSI_CLR	SPI_GPIO->BSRRH=1<<SPI_MOSI    
